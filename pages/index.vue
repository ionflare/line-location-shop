  ...
  <v-app id="inspire">
    ...
    >
      <v-toolbar-title style="width: 300px" class="ml-0 pl-3">
        ...
        <span class="hidden-sm-and-down">Test Line Search</span>
      </v-toolbar-title>
    ...
    >
      ...
      >
        ...
        <v-toolbar-title>店舗情報 {{shops[0].name}}</v-toolbar-title>
        <v-spacer></v-spacer>
                  ...
                  <v-flex xs7>
                    <v-card-title primary-title>
                      <div>
                        ...
                        <div>{{ genPrice(shop.price) }}</div>
                        <div>{{ genAddress(shop.address) }}</div>
                      </div>
                    </v-card-title>
                  </v-flex>
                  <v-flex xs5>
...
<script>
 ...
 export default{   
    ...
    methods :{
      genShopName : function (inputTxt) {
          return "名 : "+ inputTxt;
      },
      genAddress : function (inputTxt) {
          return "住所 : "+ inputTxt;
      }, 
